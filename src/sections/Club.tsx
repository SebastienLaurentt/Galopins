...
function Club() {
    return (
        ...
        >
            ...
            <p className='px-4 md:px-20 wideScreen'>Notre club est une association à but non lucratif régie par la loi de 1901.  Des randonnées sont  proposées le <strong>Lundi après-midi</strong> et le <strong>Vendredi</strong> à la journée. Le Lundi, <strong>deux niveaux de difficultés</strong> sont possibles : 
            </p>
            <ul className='flex flex-col xl:flex-row xl:items-center gap-y-8 md:justify-around text-center mb-4 md:mb-12 wideScreen'>
                <li>
                    <ParcoursCard 
            ...
            <div className='px-4 md:px-20 wideScreen'>
                    <p><strong>Une fois par an</strong> une sortie en bus est organisée et reste ouverte aux non-adhérents. Par exemple, des lieux tels que St Guilhèm le Désert, La St Baume, Les sentiers de Pagnol, mais aussi les carrières d’ocre de Rustrel, Le pont du Gard ou L’étang du Vaccarès ont déja été visités. </p>
                    <p>
