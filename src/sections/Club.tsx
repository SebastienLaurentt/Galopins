    ...
    return (
        ...
        >
            ...
            <SubSection>
                ...
                <div className=''>
                        <p><strong>Une fois par an</strong> une sortie en bus est organisèe et reste ouverte aux non-adhérents. Par exemple, des lieux tels que St Guilhèm le Désert, La St Baume, Les sentiers de Pagnol, mais aussi les carrières d’ocre de Rustrel, Le pont du Gard ou L’étang du Vaccarès ont déja étés visités. </p>
                        <p>
