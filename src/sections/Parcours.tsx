...
import Programme2PDF from "../../public/pdf/TRIMESTRE2_2024.pdf";

function Parcours() {
  const [selectedProgName, setSelectedProgName] =
    useState<string>("TRIMESTRE2_2024"); // Par défaut, sélectionnez TRIMESTRE2_2024

  const programOptions = [
    { value: "TRIMESTRE2_2024", label: "TRIMESTRE 2 2024" },
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex flex-col items-center md:items-start px-4 md:px-12 xl:px-20 wideScreen">
        <p className="mb-3">
          Les programmes des randonnées sont établis pour une période de{" "}
          <strong>4 mois</strong>. Vous pouvez choisir puis télécharger le
          programme que vous souhaitez ci-dessous :{" "}
        </p>
        <div className="flex flex-row justify-center items-center gap-x-2">
          ...
          {selectedProgName === "TRIMESTRE2_2024" && (
            <DownloadButton
              file={Programme2PDF}
              fileName="TRIMESTRE2_2024.pdf"
              linkName="TÉLÉCHARGER TRIMESTRE 2 2024"
              classname=""
            />
          )}
      ...
      <div className="mb-2 px-4 md:px-12 xl:px-20 wideScreen">
        ...
        <ul className="list-disc text-start leading-7 xl:leading-9 md:ml-8">
          <li>
            <p className="">
              {" "}
              <Tag classname="bg-white" tagName="BLANC" /> : Rando{" "}
          ...
          <li>
            <p className="">
              {" "}
              <Tag classname="bg-cyan-500" tagName="BLEU" /> : Rando{" "}
          ...
          <li>
            <p className="">
              {" "}
              <Tag classname="bg-yellow-400" tagName="JAUNE" /> : Rando{" "}
              <strong>classique</strong> du Lundi en Ardèche
            </p>
          </li>
          <li>
            <p className="">
              {" "}
              <Tag classname="bg-emerald-400" tagName="VERT" /> : les randonnées
              du Vendredi
            </p>
          </li>
        </ul>
      ...
      <div className="mb-3  flex flex-col items-center md:items-start px-4 md:px-12 xl:px-20 wideScreen">
        <p className="mb-3">
          Le <strong>lundi</strong>, le lieu de rendez-vous avant chaque départ
          est situé sur le parking en face du 95 Route de Valence (Bar le
          Provence) avec une heure de départ fixée à 13h30.
        </p>
        <LinkButton
        ...
        />
        <p className="mt-5">
          Le <strong>vendredi</strong>, les lieux de rendez-vous et de départ
          seront précisés par mail ou sur le site par l'accompagnateur.{" "}
        </p>
      </div>
      <div className="px-4 md:px-12 xl:px-20 wideScreen">
        <p>
          Les Galopins se déplacent toujours en <strong>covoiturage</strong>{" "}
          afin de limiter le nombre de voitures. Le tarif est laissé à
          l’appréciation du conducteur.
        </p>
      </div>
      <ScrollTop />
    </Section>
